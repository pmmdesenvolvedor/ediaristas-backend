...
<div class="mb-3">
  <label for="cpf_masked" class="form-label">CPF</label>
  <input value="{{@$diarista->cpf}}" type="text" class="form-control" id="cpf_masked" name="cpf_masked" required maxlength="14" onchange="getUnmaskedValue('cpf')">
  <input value="{{@$diarista->cpf}}" type="hidden" id="cpf" name="cpf" >
</div>
<div class="mb-3">
...
<div class="mb-3">
  <label for="telefone_masked" class="form-label">Telefone</label>
  <input value="{{@$diarista->telefone}}" type="text" class="form-control" id="telefone_masked" name="telefone_masked" required maxlength="15" onchange="getUnmaskedValue('telefone')">
  <input value="{{@$diarista->telefone}}" type="hidden" id="telefone" name="telefone" >
</div>
<div class="mb-3">
...
<div class="mb-3">
  <label for="cep_masked" class="form-label">CEP</label>
  <input value="{{@$diarista->cep}}" type="text" class="form-control" id="cep_masked" name="cep_masked" required maxlength="9" onchange="getUnmaskedValue('cep')">
  <input value="{{@$diarista->cep}}" type="hidden" id="cep" name="cep" >
</div>
<div class="mb-3">
